...
export const siteConfig: SiteConfig = {
	title: "lladlam",
	subtitle: "lladlam的网站",
	siteURL: "http://www.lladlam.top/", // 请替换为你的站点URL，以斜杠结尾
	...
	links: [
		...
		// 支持自定义导航栏链接,并且支持多级菜单,3.1版本新加
		{
			...
			children: [
				{
					name: "GitHub",
					url: "https://github.com/lladlam",
					external: true,
					icon: "fa6-brands:github",
				},
				{
					name: "Bilibili",
					url: "https://bilibili.lladlam.top",
					external: true,
...
export const profileConfig: ProfileConfig = {
	avatar: "assets/images/lladlam.jpg", // 相对于 /src 目录。如果以 '/' 开头，则相对于 /public 目录
	name: "lladlam",
	bio: "永远相信美好的事情即将发生",
	typewriter: {
...
export const footerConfig: FooterConfig = {
	...
	customHtml: "<img src='https://count.getloli.com/@lladlam-blog?name=lladlam-blog&theme=moebooru&padding=7&offset=0&align=top&scale=1&pixelated=1&darkmode=auto' />", // HTML格式的自定义页脚信息，例如备案号等，默认留空
...
export const pioConfig: import("./types/config").PioConfig = {
	...
	dialog: {
		...
		home: "点击这里返回首页！", // 首页提示
		skin: ["想看看我的新衣服吗？", "这套新衣服看起来真棒~"], // 换装提示
		close: "QWQ 下次再见~", // 关闭提示
		link: "https://github.com/lladlam", // 关于链接
	},
};
